...
describe('downloadAndSetupWitness', () => {
  ...
  test('should download and set up witness for Linux', async () => {
    ...
    // Verify directory creation and extraction
    expect(mockFs.existsSync).toHaveBeenCalledWith('./witness');
    expect(mockFs.mkdirSync).toHaveBeenCalledWith('./witness', { recursive: true });
    expect(mockExtractTar).toHaveBeenCalledWith('/tmp/downloaded-witness.tar.gz', './witness');
  ...
  test('should download and set up witness for macOS', async () => {
    ...
    // Verify no directory creation needed
  ...
  test('should handle chmod error gracefully', async () => {
    ...
    expect(mockCore.warning).toHaveBeenCalledWith('Failed to make witness executable: Permission denied');
